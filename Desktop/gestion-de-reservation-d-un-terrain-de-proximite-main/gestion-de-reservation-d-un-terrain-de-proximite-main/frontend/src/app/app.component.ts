...
@Component({
  selector: 'app-root',
  standalone: true,
    imports: [CommonModule, RouterLink, SignUpComponent, RouterLinkActive, RouterOutlet, CardTerrainComponent, HttpClientModule, ListTerrainsComponent, TerrainSearchComponent, NavBarComponent, InfoTabComponent,BreadcrumbModule],
